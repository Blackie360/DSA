...
node *create() 
{
    ...
    printf("Enter the details for the family member (-1 to stop adding): ");
    scanf("%d", &x);
    ...
    printf("Enter details for the left family member of %d:\n", x);
    newnode->left = create();

    printf("Enter details for the right family member of %d:\n", x);
